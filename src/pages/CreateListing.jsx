    ...
    <main className='max-w-md px-2 mx-auto'>
      ...
      <form onSubmit={onSubmit}>
        ...
        <div className='flex space-x-6 mb-6'>
          ...
          <div className='flex flex-col'>
            <p className='text-lg mt-6 font-semibold'>Bathroom</p>
        ...
        <textarea type="text" id='address' value={address} onChange={onChange} placeholder='Address' required className='w-full px-4 py-2 text-lg text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 mb-4' />
        {!geoLocationEnabled && (
        ...
        <textarea type="text" id='description' value={description} onChange={onChange} placeholder='Description' required className='w-full px-4 py-2 text-lg text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 mb-4' />
